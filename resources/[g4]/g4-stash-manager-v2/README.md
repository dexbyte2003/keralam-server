...
2. Use the command `/invmng` to open the creator menu.
...
## Permissions
By default, the `/invmng` command is open to everyone. You should wrap the command in your framework's permission check (e.g., Qbox, QBCore, ESX).

Example for Qbox/QBCore:
```lua
RegisterCommand('invmng', function(source)
