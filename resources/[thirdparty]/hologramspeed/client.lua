...
function CommandHandler(args)
	...
	elseif args[1] == "rotate" then
		...
		SavePlayerProfile()
		SendChatMessage(string.format(msgSuc, args[1], nx, ny, nz))
	elseif args[1] == "changeunit" then
		if args[2] == "kmph" then
			usingMetric = true
		elseif args[2] == "mph" then
			usingMetric = false
		else
			SendChatMessage("^1Usage: ^0/hsp changeunit <kmph|mph>^r")
		end

	else
		SendChatMessage("^1Usage: ^0/hsp <theme|offset|rotate|changeunit> [args...]^r")
	end
end
