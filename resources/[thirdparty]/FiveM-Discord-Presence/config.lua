...
Line2 = 'location'
--]] 
Config.Framework = 'QB' -- Framework, can be either "QB", "ESX", or "STANDALONE"
--Anything you dont want to show up can be left blank, except for AppId.
Config.Discord = {
AppId = "1423617311818121258", -- The discord application ID.
BigAsset = 'keralamlogo', -- Name of a rich presence asset, will show up as the big image
BigText = 'KERALAM SERVER', -- Text that will show when someone hovers over the big image
...
Button1Text = 'healthdisplay', -- Text that will appear on the first button
Button1Link = 'CHANGEME', -- Link that will open when pressing the first button
Button2Text = 'Discord', -- Text that will appear on the second button
